...
Based on this complete strategy, analyze the data and return ONLY a JSON object with the three keys: "buyorsellentryPoint", "stopLoss", and "takeProfit". Do not include any other text, markdown, or explanations.
